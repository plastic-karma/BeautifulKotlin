...
/**
 * We are creating an object, like a builder and then we are calling many methods on that object. We always repeat the
 * object reference to call the methods upon. Is there a better way in Kotlin to do this?
 */
